...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('/front-assets/css/mediaelementplayer.css') }}">
    <link rel="stylesheet" href="{{ asset('/front-assets/css/animate.css') }}">
    <link rel="stylesheet" href="{{ asset('/front-assets/fonts/flaticon/font/flaticon.css') }}">
    <link rel="stylesheet" href="{{ asset('/front-assets/css/fl-bigmug-line.css') }}">
...
<body>
    ...
    <script src="{{ asset('/front-assets/js/mediaelement-and-player.min.js') }}"></script>
    ...
    <script src="{{ asset('/front-assets/js/main-front.js') }}"></script>
